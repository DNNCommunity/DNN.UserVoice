...
namespace DNN.Modules.DnnUserVoice.Services
{
    ...
    using static DNN.Modules.DnnUserVoice.ViewModels.LocalizationViewModel;
    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        public LocalizationService()
        {
            ...
            this.cacheKey = "DNN.Modules.DnnUserVoice" + "_Localization_" + Thread.CurrentThread.CurrentCulture;
